...
// Direct Image Uploader utility function
// Streamlines image upload by bypassing modals and opening file picker directly
window.initDirectImageUploader = function (config) {
    const button = document.getElementById(config.buttonId);
    const fileInput = document.getElementById(config.inputId);
    const validator = config.validator;
    const validatorKey = config.validatorKey;
    ...
    // Preview and validate on file selection
